...
<body class="bg-gradient-to-r from-blue-400 to-blue-300 flex items-center justify-center h-screen">
    ...
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md transform hover:scale-105 transition-all duration-300 ease-in-out">
        ...
        <form action="password_reset_artist.php" method="post">
            <!-- Email Input -->
            <div class="mb-6">
        ...
        <div class="text-center mt-6 text-sm text-gray-600">
            <p>Remembered your password? <a href="../ArtistLogin.php" class="text-blue-600 hover:text-blue-700 font-medium">Login</a></p>
        </div>
    </div>
